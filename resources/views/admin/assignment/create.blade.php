                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="box-body pad">
                                <form role="form" method="post" action="{{route('admin.assignment.store')}}">
                                    @csrf
                                      <div class="col-md-6">
                                     ...
                                     @error('semester_id')
                                      ...
                                      @enderror
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="assignment_title" placeholder="Assignment Title">
                                        </div>
                                     @error('assignment_title')
                                      ...
                                      @enderror
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="date" class="form-control" name="deadline" placeholder="Enter Assign Deadline">
                                        </div>
                                     </div>
                                     @error('deadline')
                                       <span class="invalid-feedback" role="alert">
                                     ...
                                     <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <textarea style="width: 100%; height: 182px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;" type="text" class="form-control" name="message_to_student" placeholder="Message for students"></textarea>
                                       </div>
                                     @error('message_to_student')
                                      ...
                                      @enderror
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="assignment_subject" placeholder="Assignment Subject">
                                        </div>
                                      ...
                                      @enderror
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="teacher_name" placeholder="Assignment Teacher Name">
                                        </div>
                                     @error('teacher_name')
                                       <span class="invalid-feedback" role="alert">
                                        <strong style="color: red;">*{{ $message }}*</strong>
